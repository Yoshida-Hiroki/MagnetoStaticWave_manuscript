...
%DIF ADD 260222_MSEW.tex      Mon May 18 10:32:48 2026
%DIF < % journal:APEX
...
\cite{Kittel1949,KittelAbrahams1953,CallenCallen1963}}\hskip0pt%DIFAUXCMD
, while retaining the explicitly long-range character of the dipolar interaction. From this coupling, a }\DIFaddend new volume force term $-\bm{f}$ appears in the Navier--Cauchy equation~(\ref{eq:NavierCauchy}), where the force density $\bm{f}$ is given by (see Supplementary data~\cite{SM} for details of the derivation)
\begin{equation}
