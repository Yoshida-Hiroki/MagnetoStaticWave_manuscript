...
%DIF ADD 260222_MSEW.tex      Fri May 22 16:00:45 2026
%DIF < % journal:APEX
...
, while retaining the explicitly long-range character of the dipolar interaction. In addition, the elasticity tensor receives a magnetostatic contribution, and a }\DIFaddend new volume force term $-\bm{f}$ appears in the Navier--Cauchy equation~(\ref{eq:NavierCauchy}), where the force density $\bm{f}$ is given by (see Supplementary data~\cite{SM} for details of the derivation)
\begin{equation}
