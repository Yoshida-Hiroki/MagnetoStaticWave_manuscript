...
\section*{Magnetoelastic Waves in Ferromagnetic Thin Films Mediated by Dipolar Interactions: Supplementary data}

% Hiroki Yoshida$^1$, Ryohei Kono$^1$, Manato Fujimoto$^2$, Motoki Asano$^3$, \\Daiki Hatanaka$^3$, Kei Yamamoto$^{4,5}$, Shuichi Murakami$^{2,5,6}$\\
...
\subsection{Derivation of the dipolar field}
...
\be
    \bm{h}^{\mathrm{in}}(z)=\int_{-\frac{L}{2}}^{\frac{L}{2}}\rmd z'\left[G^m(z,z')\bm{m}(z')+G^u(z,z')\bm{u}(z')\right],
\ee
...
\subsection{Derivation of the force}
