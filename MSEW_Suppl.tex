...
\ee
where \(\nabla_{\bm{R}}\) is a derivative with respect to \(\bm{R}\). We go back to the coordinate \(\bm{r}\) from these equations. Here we need to pay attention to the conservation of the magnetization~\cite{Yamamoto_Maekawa_AnnPhys}:
\be
...
The Euler--Lagrange equation about $u^*_i$ gives
\be
