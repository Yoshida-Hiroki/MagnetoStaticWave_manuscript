...
Next, we examine the effect of the magnetoelastic coupling in the dynamics of the magnetostatic and elastic waves. In the absence of the coupling, the dynamics of magnetization $\bm{m}$ upto its first-order is described by the linearized Landau--Lifshitz equation
\begin{equation}
