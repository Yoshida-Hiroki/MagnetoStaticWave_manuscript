...
Magneto-elastic coupling is a focus of recent studies with the prospect of enhancing the manipuration of magnetic properties of materials. In quantum mechanics length scale, two degree of freedoms are connected via spin-orbit coupling, which is a local interaction and cause magnon-phonon coupling. On the other hand, coupling at classical dynamics length scale is mainly dominated by the magnetic dipolar interaction. In this case, magnetostatic waves and elastic waves are coupled. Experimantal investigation of this realm is advanced thanks to the development of IDT and precise experiment is possible. However, there does not exist a microscopic theory that treats the non-local dipolar interaction thus far. In this Letter, we construct a general formalism to deal with dipolar interaction and resulting magnetostatic-elastic waves.
...
\begin{figure*}
    \begin{center}
        ...
        \caption{Dispersion curves of the coupled wave. Red and blue curves show symmetric and anti-symmetric modes of uncoupled waves, respectively. The black dots represent the dispersion of the coupled wave. The direction of the external magnetic field is (a) $\bm{H}_0\parallel\bm{k} (\varphi=0)$, (b) $\varphi=\pi/4$, and (c) $\bm{H}_0\perp\bm{k}\ (\varphi=\pi/2)$. The insets are magnifications of some of the band crossings. Level repulsion occurs at crossings of same colored curves i.e. between modes with the same parity.}
        \label{fig:Bands}
    \end{center}
\end{figure*}
