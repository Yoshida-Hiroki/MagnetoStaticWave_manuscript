...
We have added the following sentences after Eq.~(15) in the main text:
...
\begin{equation}
    ...
    \right]\nonumber
\end{equation}
arises from the $\bm{h}^*\cdot\bm{h}$ term in the Lagrangian. This term is analogous to the standard local magnetoelastic coupling density~[18,19,20,21], while explicitly retaining the long-range character of the dipolar interaction.
\end{quote}
